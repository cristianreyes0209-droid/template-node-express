...
function normalizeText(text: string) {
  return text
    ...
    .replace(/\./g, " ")
    .replace(/\s+/g, " ")
    .replace("deseo una de ", "")
    .replace("quiero una de ", "")
    .replace("me das una de ", "")
    .replace("regalame una de ", "")
    .replace("regálame una de ", "")
    .replace("una de ", "")
    ...
    .replace("estroganoff", "strogonoff")
    .replace("camorones", "camarones")
    .replace("camarones", "camarones")
    .replace("camarone", "camarones")
    .replace("stroganof", "strogonoff");
}
